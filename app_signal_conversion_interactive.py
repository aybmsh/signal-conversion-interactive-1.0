...
show_binary_labels = st.sidebar.checkbox("Show Binary Labels", value=True)
...
if show_quantized:
    fig.add_trace(go.Scatter(x=sample_times, y=quantized_ampl, mode="markers",
...
fig.update_layout(
    title="Signal Digitization Process",
    xaxis_title="Time (s)",
